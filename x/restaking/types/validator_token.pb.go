...
type ValidatorToken struct {
	...
	Total     github_com_cosmos_cosmos_sdk_types.Coin `protobuf:"bytes,2,opt,name=total,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Coin" json:"total"`
	Retire    github_com_cosmos_cosmos_sdk_types.Coin `protobuf:"bytes,3,opt,name=retire,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Coin" json:"retire"`
	Available github_com_cosmos_cosmos_sdk_types.Coin `protobuf:"bytes,4,opt,name=available,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Coin" json:"available"`
}
...
var fileDescriptor_8512cd1427318303 = []byte{
	...
	,
}
...
func (m *ValidatorToken) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0x22
	{
		size := m.Retire.Size()
		i -= size
		if _, err := m.Retire.MarshalTo(dAtA[i:]); err != nil {
			return 0, err
		}
		i = encodeVarintValidatorToken(dAtA, i, uint64(size))
	}
