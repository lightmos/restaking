...
func init() {
	...
	md_CommissionRates = File_lightmos_restaking_restaking_proto.Messages().ByName("CommissionRates")
...
func (x *CommissionRates) slowProtoReflect() protoreflect.Message {
	mi := &file_lightmos_restaking_restaking_proto_msgTypes[0]
...
func (x *fastReflection_CommissionRates) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "lightmos.restaking.CommissionRates.rate":
		return x.Rate != ""
	case "lightmos.restaking.CommissionRates.max_rate":
		return x.MaxRate != ""
	case "lightmos.restaking.CommissionRates.max_change_rate":
		return x.MaxChangeRate != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: lightmos.restaking.CommissionRates"))
		}
		panic(fmt.Errorf("message lightmos.restaking.CommissionRates does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_CommissionRates) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message lightmos.restaking.CommissionRates does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_CommissionRates) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "lightmos.restaking.CommissionRates.rate":
		panic(fmt.Errorf("field rate of message lightmos.restaking.CommissionRates is not mutable"))
	case "lightmos.restaking.CommissionRates.max_rate":
		panic(fmt.Errorf("field max_rate of message lightmos.restaking.CommissionRates is not mutable"))
	case "lightmos.restaking.CommissionRates.max_change_rate":
		panic(fmt.Errorf("field max_change_rate of message lightmos.restaking.CommissionRates is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: lightmos.restaking.CommissionRates"))
		}
...
func (x *fastReflection_CommissionRates) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in lightmos.restaking.CommissionRates", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_lightmos_restaking_restaking_proto_init()
	md_Commission = File_lightmos_restaking_restaking_proto.Messages().ByName("Commission")
...
func (x *Commission) slowProtoReflect() protoreflect.Message {
	mi := &file_lightmos_restaking_restaking_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_Commission) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "lightmos.restaking.Commission.commission_rates":
		return x.CommissionRates != nil
	case "lightmos.restaking.Commission.update_time":
		return x.UpdateTime != nil
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: lightmos.restaking.Commission"))
		}
		panic(fmt.Errorf("message lightmos.restaking.Commission does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Commission) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message lightmos.restaking.Commission does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Commission) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in lightmos.restaking.Commission", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_lightmos_restaking_restaking_proto_init()
	md_Description = File_lightmos_restaking_restaking_proto.Messages().ByName("Description")
...
func (x *Description) slowProtoReflect() protoreflect.Message {
	mi := &file_lightmos_restaking_restaking_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_Description) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "lightmos.restaking.Description.moniker":
		return x.Moniker != ""
	case "lightmos.restaking.Description.identity":
		return x.Identity != ""
	case "lightmos.restaking.Description.website":
		return x.Website != ""
	case "lightmos.restaking.Description.security_contact":
		return x.SecurityContact != ""
	case "lightmos.restaking.Description.details":
		return x.Details != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: lightmos.restaking.Description"))
		}
		panic(fmt.Errorf("message lightmos.restaking.Description does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Description) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message lightmos.restaking.Description does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Description) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "lightmos.restaking.Description.moniker":
		panic(fmt.Errorf("field moniker of message lightmos.restaking.Description is not mutable"))
	case "lightmos.restaking.Description.identity":
		panic(fmt.Errorf("field identity of message lightmos.restaking.Description is not mutable"))
	case "lightmos.restaking.Description.website":
		panic(fmt.Errorf("field website of message lightmos.restaking.Description is not mutable"))
	case "lightmos.restaking.Description.security_contact":
		panic(fmt.Errorf("field security_contact of message lightmos.restaking.Description is not mutable"))
	case "lightmos.restaking.Description.details":
		panic(fmt.Errorf("field details of message lightmos.restaking.Description is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: lightmos.restaking.Description"))
		}
...
func (x *fastReflection_Description) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in lightmos.restaking.Description", d.FullName()))
	}
	panic("unreachable")
}
...
func (*CommissionRates) Descriptor() ([]byte, []int) {
	return file_lightmos_restaking_restaking_proto_rawDescGZIP(), []int{0}
}
...
func (*Commission) Descriptor() ([]byte, []int) {
	return file_lightmos_restaking_restaking_proto_rawDescGZIP(), []int{1}
}
...
func (*Description) Descriptor() ([]byte, []int) {
	return file_lightmos_restaking_restaking_proto_rawDescGZIP(), []int{2}
}
...
var File_lightmos_restaking_restaking_proto protoreflect.FileDescriptor

var file_lightmos_restaking_restaking_proto_rawDesc = []byte{
	0x0a, 0x22, 0x6c, 0x69, 0x67, 0x68, 0x74, 0x6d, 0x6f, 0x73, 0x2f, 0x72, 0x65, 0x73, 0x74, 0x61,
	0x6b, 0x69, 0x6e, 0x67, 0x2f, 0x72, 0x65, 0x73, 0x74, 0x61, 0x6b, 0x69, 0x6e, 0x67, 0x2e, 0x70,
	0x72, 0x6f, 0x74, 0x6f, 0x12, 0x12, 0x6c, 0x69, 0x67, 0x68, 0x74, 0x6d, 0x6f, 0x73, 0x2e, 0x72,
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xac, 0x02, 0x0a, 0x0f, 0x43, 0x6f, 0x6d, 0x6d, 0x69, 0x73,
	...
	0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x52, 0x61, 0x74, 0x65, 0x3a, 0x08, 0x98, 0xa0, 0x1f, 0x01,
	0xe8, 0xa0, 0x1f, 0x01, 0x22, 0xb7, 0x01, 0x0a, 0x0a, 0x43, 0x6f, 0x6d, 0x6d, 0x69, 0x73, 0x73,
	...
	0x6e, 0x67, 0x2e, 0x43, 0x6f, 0x6d, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x52, 0x61, 0x74,
	0x65, 0x73, 0x42, 0x08, 0xc8, 0xde, 0x1f, 0x00, 0xd0, 0xde, 0x1f, 0x01, 0x52, 0x0f, 0x63, 0x6f,
	0x6d, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x52, 0x61, 0x74, 0x65, 0x73, 0x12, 0x45, 0x0a,
	...
	0xc8, 0xde, 0x1f, 0x00, 0x90, 0xdf, 0x1f, 0x01, 0x52, 0x0a, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65,
	0x54, 0x69, 0x6d, 0x65, 0x3a, 0x08, 0x98, 0xa0, 0x1f, 0x01, 0xe8, 0xa0, 0x1f, 0x01, 0x22, 0xac,
	...
	,
}

var (
	file_lightmos_restaking_restaking_proto_rawDescOnce sync.Once
	file_lightmos_restaking_restaking_proto_rawDescData = file_lightmos_restaking_restaking_proto_rawDesc
)

func file_lightmos_restaking_restaking_proto_rawDescGZIP() []byte {
	file_lightmos_restaking_restaking_proto_rawDescOnce.Do(func() {
		file_lightmos_restaking_restaking_proto_rawDescData = protoimpl.X.CompressGZIP(file_lightmos_restaking_restaking_proto_rawDescData)
	})
	return file_lightmos_restaking_restaking_proto_rawDescData
}

var file_lightmos_restaking_restaking_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_lightmos_restaking_restaking_proto_goTypes = []interface{}{
	(*CommissionRates)(nil),       // 0: lightmos.restaking.CommissionRates
	(*Commission)(nil),            // 1: lightmos.restaking.Commission
	(*Description)(nil),           // 2: lightmos.restaking.Description
	(*timestamppb.Timestamp)(nil), // 3: google.protobuf.Timestamp
}
var file_lightmos_restaking_restaking_proto_depIdxs = []int32{
	0, // 0: lightmos.restaking.Commission.commission_rates:type_name -> lightmos.restaking.CommissionRates
	3, // 1: lightmos.restaking.Commission.update_time:type_name -> google.protobuf.Timestamp
...
func init() { file_lightmos_restaking_restaking_proto_init() }
func file_lightmos_restaking_restaking_proto_init() {
	if File_lightmos_restaking_restaking_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_lightmos_restaking_restaking_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_lightmos_restaking_restaking_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_lightmos_restaking_restaking_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_lightmos_restaking_restaking_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_lightmos_restaking_restaking_proto_goTypes,
		DependencyIndexes: file_lightmos_restaking_restaking_proto_depIdxs,
		MessageInfos:      file_lightmos_restaking_restaking_proto_msgTypes,
	}.Build()
	File_lightmos_restaking_restaking_proto = out.File
	file_lightmos_restaking_restaking_proto_rawDesc = nil
	file_lightmos_restaking_restaking_proto_goTypes = nil
	file_lightmos_restaking_restaking_proto_depIdxs = nil
}
