...
const (
	Query_Params_FullMethodName            = "/lightmos.restaking.Query/Params"
	Query_SellOrderBook_FullMethodName     = "/lightmos.restaking.Query/SellOrderBook"
	Query_SellOrderBookAll_FullMethodName  = "/lightmos.restaking.Query/SellOrderBookAll"
	Query_BuyOrderBook_FullMethodName      = "/lightmos.restaking.Query/BuyOrderBook"
	Query_BuyOrderBookAll_FullMethodName   = "/lightmos.restaking.Query/BuyOrderBookAll"
	Query_DenomTrace_FullMethodName        = "/lightmos.restaking.Query/DenomTrace"
	Query_DenomTraceAll_FullMethodName     = "/lightmos.restaking.Query/DenomTraceAll"
	Query_ValidatorToken_FullMethodName    = "/lightmos.restaking.Query/ValidatorToken"
	Query_ValidatorTokenAll_FullMethodName = "/lightmos.restaking.Query/ValidatorTokenAll"
)
